...
public class UpdateActivity extends AppCompatActivity {
    ...
    private String url = Http.server + "detail.php?mahasiswa_id=" + Re.MAHASISWA_ID;
    ...
    private void Update(){
        if (edit_nim.getText().toString().equals("") || edit_nama.getText().toString().equals("") ||
            ...
            Snackbar.make(edit_nim, "Tidak boleh ada yang kosong", Snackbar.LENGTH_LONG).show();
        } else {
    ...
    public void ListDrawer() {
        ...
        try {
            ...
            for (int i = 0; i < jsonMainNode.length(); i++) {
                ...
                edit_nim.setText( jsonChildNode.optString("nim") );
                edit_nama.setText( jsonChildNode.optString("nama") );
                edit_alamat.setText( jsonChildNode.optString("alamat") );
                text_prodi.setText( jsonChildNode.optString("prodi_nama") );
                Re.PRODI_ID = jsonChildNode.optString("prodi_id");
                text_tgllahir.setText( jsonChildNode.optString("tgl_lahir1") );
                Re.TGL_LAHIR = jsonChildNode.optString("tgl_lahir2");
