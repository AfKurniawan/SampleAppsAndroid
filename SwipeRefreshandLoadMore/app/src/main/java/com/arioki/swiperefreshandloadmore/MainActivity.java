package com.arioki.swiperefreshandloadmore;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Swipe Refresh and Load More");
    ...
    private void populateLoadmoreData() {
        String loadmoreText = "Tambah Bawah ke = -";
        for (int i = 0; i < 10; i++){
            nuMore = nuMore +1;
            list.addLast(loadmoreText + nuMore);
        }
    ...
    private void populatePullRefreshData() {
        String swipePullRefreshText = "Tambah Atas Ke = -";
        for (int i = 0; i < 5; i++){
            numUp = numUp +1;
            list.addFirst(swipePullRefreshText + numUp);
        }
